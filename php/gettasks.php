...
function getTasks($user, $projet_id) {
  ...
  require 'connection.php';
    ...
    if ($user == 'all') {
      ...
      $sql = "SELECT * FROM tache WHERE projet_id = ".$projet_id." ORDER BY `fait` ASC,  `tache_id` ASC  ";
    ...
    $sql = "SELECT * FROM tache WHERE utilisateur = '".$user."' AND projet_id = ". $projet_id ." ORDER BY `fait` ASC, `tache_id` ASC" ;
    $result = $conn->query($sql);
